...
<body>
    ...
    <div class="d-md-none">
        <a id="stickyWp" title="Consultanos por WhatsApp" href="https://wa.me/5492494697996?text=Hola,%20necesito%20hacerles%20una%20consulta..." target="_blank"><img class="center" src="\images\general\whatsapp-24.ico" width="30" height="30"></a>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="row">
                <div class="col-md-12 d-none d-md-block">
                    <div class="col-md-4 float-left montserrat300"><p>Servicio de Ingenieria digital para el desarrollo productivo</p></div>

                    <div class="col-md-8 float-right">
                        <ul class="navbar-nav float-right">
                            <li class="nav-item pr-2">
                                <a class="btn btn-light" href="https://www.instagram.com/gydingenieria/" target="_blank"><i class="fab fa-instagram"></i> INSTAGRAM</a>
                            </li>
                            <li class="nav-item pr-2">
                                <a class="btn btn-light" href="https://www.facebook.com/gydingenieria" target="_blank"><i class="fab fa-facebook"></i> FACEBOOK</a>
                            </li>
                            ...
                            <li class="nav-item pr-2">
                                <a class="btn btn-light" href=" https://www.linkedin.com/company/g-d-ingenier%C3%ADa-de-precisi%C3%B3n" target="_blank"><i class="fab fa-linkedin"></i> LINKEDIN</a>
                            </li>
                            <li class="nav-item pr-2">
                ...
                <div class="col-md-12 d-flex align-self-center d-none d-sm-block d-md-none">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <a class="btn btn-light" href="https://www.facebook.com/gydingenieria" target="_blank"><i class="fab fa-facebook"></i></a>

                        <a class="btn btn-light" href="https://www.instagram.com/gydingenieria/" target="_blank"><i class="fab fa-instagram"></i></a>
                        ...
                        <a class="btn btn-light" href="https://www.linkedin.com/company/g-d-ingenier%C3%ADa-de-precisi%C3%B3n" target="_blank"><i class="fab fa-linkedin"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex justify-content-around">
                    <div class="row">
                        ...
                        <div class="col-md-4 rounded-circle navbar logo">
                            <a href="/"><img class="logo-top" src="\images\general\logo-top.png"></a>
                        </div>
