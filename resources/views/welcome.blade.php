        ...
        <div class="row justify-content-center">
            ...
            <div class="card-deck col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 href="/explorer" class="card-title text-success montserrat300">DRON <span class="montserrat600">XPLORER PRO</span><i class="fas fa-chevron-circle-right text-right text-dark pl-2"></i></h5>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-success montserrat300">DRON <span class="montserrat600">XPLORER</span> <i class="fas fa-chevron-circle-right text-dark pl-2"></i></h5>
                    </div>
                </div>
