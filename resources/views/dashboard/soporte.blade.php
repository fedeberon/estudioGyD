            ...
            <div class="row h-100 align-items-end">
                <div class="col-4 mx-auto">
                    <form action={{route('soporte')}} method="POST">
                        ...
                        <div class="row">
                            <button type="submit" id='btn-contact' class="btn btn-primary col-6 ml-3" data-toggle="modal" data-target="#soporte">Enviar</button>
                        </div>
                    </form>
                    <hr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content align-items-center">
                        <div class="modal-header">
                            <h5 class="modal-title">Su peticion esta siendo procesada.</h5>
                        </div>
